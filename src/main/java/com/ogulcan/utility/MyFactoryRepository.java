...
public class MyFactoryRepository <T,ID> implements ICrud<T,ID>{
   ...
   public void closeSession(){
     ...
     * kolon adı ve değeri , kolon adı olarak değişkenin adını,
     * kolon değeri olarak değişkenin
        ...
        try{
            ...
            for(int i=0; i<fl.length;i++){
                ...
                if (fl[i].get(entity) != null && !fl[i].getName().equals("id")) {
                    /**
                     * Boolean, String, Long vs bu türlerin sorguları farklı olacaktır. bu nedenle bunları
